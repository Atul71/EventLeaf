            ...
            <div className="space-y-6">
              <div className="relative">
                <div className="absolute inset-0 flex items-center">
                  <div className="w-full border-t border-border-green dark:border-white/10" />
                </div>
                <div className="relative flex justify-center text-xs uppercase">
                  <span className="bg-background-light dark:bg-background-dark px-4 text-subtext-leaf font-semibold tracking-wider">
                    Or continue with
                  </span>
                </div>
              </div>
              <div className="grid grid-cols-2 gap-4">
                <a
                  href="#google-login"
                  className="flex items-center justify-center gap-2 py-3 px-4 bg-white dark:bg-white/5 border border-border-green dark:border-white/10 rounded-lg hover:bg-gray-50 dark:hover:bg-white/10 transition-colors"
                >
                  ...
                  <span className="text-sm font-bold text-text-leaf dark:text-white">Google</span>
                </a>
                <a
                  href="#apple-login"
                  className="flex items-center justify-center gap-2 py-3 px-4 bg-white dark:bg-white/5 border border-border-green dark:border-white/10 rounded-lg hover:bg-gray-50 dark:hover:bg-white/10 transition-colors"
                >
                  <svg className="w-5 h-5 text-text-leaf dark:text-white" fill="currentColor" viewBox="0 0 24 24">
                    <path d="M17.05 20.28c-.96.95-2.45 2.1-4.05 2.1-2.06 0-2.67-1.28-4.9-1.28-2.26 0-2.9 1.25-4.82 1.25-1.57 0-3.23-1.27-4.24-2.7-2.1-3-1.62-7.55.45-10.53 1-1.46 2.5-2.4 4.13-2.4 1.24 0 2.44.87 3.2.87.75 0 2.22-.9 3.73-.9 1.58 0 3.03.58 4.1 1.57-4.14 2.46-3.47 7.77.63 9.42-.76 1.83-1.55 3.55-2.33 4.6zM12.03 5.4c.04-1.92 1.63-3.48 3.55-3.4 0 1.95-1.62 3.55-3.55 3.4z" />
                  </svg>
                  <span className="text-sm font-bold text-text-leaf dark:text-white">Apple</span>
                </a>
              </div>
            </div>
